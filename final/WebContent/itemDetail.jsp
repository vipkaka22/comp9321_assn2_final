...
<font>Please enter quantities needed</font>
...
<table>
	<tr><td>
		<button name='action' value='addCart' class="btn btn-5 btn-5a icon-cart">
				<span>Add to Shopping Cart</span></button>
	</td></tr>
	<tr><td align="center">
		<input type="button" name="back" style="width: 380px; height: 65px"
			value="back" class="btn btn-2 btn-2a" onclick="javascript:history.go(-1);" />
	</td></tr>
			</table>
			</form></td></tr></table>
	</center>
