...
<body>
	<table>
		<tr>
			...
			<form class="searchbox" action='control' method='POST'>
		<div id="navcontainer">
			<ul id="navlist">
...
<!--				<tr>
				...
				<tr>
					<td width="10%"><font color=red size=2></font>ConfirmPassword:</td>
					<td width="35%"><input type="password" name="ConfirmPssword"
					style="width: 100%" placeholder="******" ></td>
				</tr>
				<tr>
...
<!-- 
 ...
 -->
		...
		<center><table>
			...
			<input type='hidden' name="ID" value='<%=seller.getUsername()%>'>
			<button style="width: 150px; height: 30px" name='action' value='SellerProfileComplete'>Complete</button>
