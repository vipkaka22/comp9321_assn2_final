...
<form class="searchbox" action='user' method='POST'>
	...
	<p><center>
		...
		<center><table>
			<tr>
				<%if (curPage > 1) {%>
				<a href = "buyerSearchResultPage.jsp?curPage=<%=1%>">First Page</a>
				
				<tr>
			<span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			</tr>
			<a href = "buyerSearchResultPage.jsp?curPage=<%=curPage-1%>">Previous Page</a>
				<%}%>
			</tr>
			<tr>
			<span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			...
			%>
			<tr> <a href="buyerSearchResultPage.jsp?curPage=<%=i%>"> <%=i+startnum*10 %> </a> </tr>
			<%
					}
				}
			}
			...
			<tr>
				...
				<a href = "buyerSearchResultPage.jsp?curPage=<%=curPage+1%>">Next Page</a>
				<tr>
			<span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			</tr>
			<a href = "buyerSearchResultPage.jsp?curPage=<%=pageCount%>">Last Page</a>
				<%}%>
			</tr>
